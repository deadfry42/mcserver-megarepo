...
import static uk.co.nikodem.dFSmpPlugin.Content.CustomItems.VeinMinableBlocks.veinMinableLogs;
import static uk.co.nikodem.dFSmpPlugin.Content.CustomItems.VeinMinableBlocks.veinMinableOres;
...
public class BreakBlock implements Listener {
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        if (origin.getType() == Material.GRAVEL) {
            ...
            event.getPlayer().getWorld().dropItemNaturally(origin.getLocation(), new ItemStack(Material.GRAVEL));
        }
